...
var PLAYER_WIDTH = exports.PLAYER_WIDTH = 30,
    PLAYER_HEIGHT = exports.PLAYER_HEIGHT = 24,
    PLAYER_INITIAL_FRAME = exports.PLAYER_INITIAL_FRAME = 1,
    PLAYER_SPEED = exports.PLAYER_SPEED = 200,
    PLAYER_SNEAK_MULTIPLIER = exports.PLAYER_SNEAK_MULTIPLIER = 0.75,
    PLAYER_SPRINT_MULTIPLIER = exports.PLAYER_SPRINT_MULTIPLIER = 1.5,
    PLAYER_WALK_ANIMATION_FRAMERATE = exports.PLAYER_WALK_ANIMATION_FRAMERATE = 5,
    PLAYER_FIGHT_ANIMATION_FRAMERATE = exports.PLAYER_FIGHT_ANIMATION_FRAMERATE = 10;
...
var MIN_DISTANCE_TO_TARGET = exports.MIN_DISTANCE_TO_TARGET = 5;
...
var EntityWalkingOnPath = function (_Entity) {
  ...
  function EntityWalkingOnPath(game, imageKey, frame, targets, walls) {
    ...
    _this.pathfinder.setGrid(walls);
...
var TileMap = function (_Phaser$Tilemap) {
  ...
  */
  ...
  _createClass(TileMap, [{
    ...
    key: 'getWallsPostions',
    value: function getWallsPostions() {
      var walls = this.walls.getTiles(0, 0, 2048, 2048);
      var wallsArr = [];
...
},{"../constants/TileMapConstants":8}],16:[function(require,module,exports){
'use strict';
...
var Zombie = function (_EntityWalkingOnPath) {
  ...
  * @param {number} frame - If this Sprite is using part of a sprite sheet or texture atlas you can specify the exact frame to use by giving a numeric index.
  */
  function Zombie(game, x, y, imageKey, frame, path, walls) {
    _classCallCheck(this, Zombie);

    return _possibleConstructorReturn(this, (Zombie.__proto__ || Object.getPrototypeOf(Zombie)).call(this, game, x, y, imageKey, frame, path, walls));
  }
...
exports.pixelsToTile = exports.tileToPixels = exports.pixelsToTileY = exports.pixelsToTileX = undefined;
